...
image = processing_functions.process_image(arguments.image_dir, checkpoint['hidden_layers'])
...
probs, classes = model_functions.predict(arguments.image_dir, model, arguments.topk, arguments.gpu)  
